...
.meaning-item .trans-text {
    margin-left: 78px; /* label min-width(70px) + gap(8px) */
    width: calc(100% - 78px);
}
...
.example-line .trans-text {
    margin-left: 30px; /* speaker min-width(24px) + gap(6px) */
    width: calc(100% - 30px);
}
...
CATEGORY_CN = {
    ...
    "Simulazione": "伪装",
    # New categories from idiom 86
    "Distrazione": "分心",
    # New categories from idioms 87-92
    "Lavoro": "工作",
    "Fatica": "辛苦",
    "Assurdità": "荒谬",
    "Ironia": "讽刺",
    ...
    "Illusione": "幻想",
    "Aspettativa": "期待",
    # New categories from idioms 90-139
    "Sfortuna / Ingiustizia": "不幸 / 不公",
    "Solitudine / Scelta": "独处 / 选择",
    "Rabbia / Limite": "愤怒 / 边界",
    "Felicità / Emozioni": "幸福 / 情绪",
    "Cattivo umore / Emozioni": "坏心情 / 情绪",
    "Insuccesso / Delusione": "失败 / 失望",
    "Ossessione / Pensiero": "执念 / 思绪",
    "Opportunità / Azione": "机会 / 行动",
    "Prudenza / Precauzione": "谨慎 / 预防",
    "Realismo / Relazioni": "现实 / 人际",
    "Allegria / Umorismo": "欢乐 / 幽默",
    "Economia / Difetto": "理财 / 缺点",
    "Impossibilità / Logica": "不可能 / 逻辑",
    "Difficoltà / Pressione": "困难 / 压力",
    "Illusione / Realismo": "幻想 / 现实",
    "Famiglia / Affetto": "家庭 / 亲情",
    "Memoria / Intelligenza": "记忆 / 智力",
    "Sincerità / Trasparenza": "坦诚 / 透明",
    "Precisione / Cura": "精确 / 细致",
    "Calma / Coraggio": "冷静 / 勇气",
    "Distacco / Arretratezza": "超脱 / 落伍",
    "Mediazione / Pace": "调解 / 和平",
    "Colpa / Timore": "心虚 / 怯懦",
    "Dubbio / Normalità": "怀疑 / 正常",
    "Successo / Domanda": "成功 / 抢手",
    "Fatica / Sacrificio": "辛苦 / 牺牲",
    "Stanchezza / Sconforto": "疲惫 / 沮丧",
    "Gentilezza / Emozioni": "温柔 / 情绪",
    "Attrazione / Impressione": "吸引 / 印象",
    "Gusto personale / Appetito": "品味 / 食欲",
    "Gusto personale / Raffinamento": "品味 / 精致",
    "Stabilità / Casa": "安定 / 家",
    "Comodità / Pigrizia": "安逸 / 懒惰",
    "Abilità / Talento": "手艺 / 天赋",
    "Incomprensione / Ignoranza": "不解 / 无知",
    "Difficoltà / Carattere": "困难 / 个性",
    "Errore / Previdenza": "错误 / 预判",
    "Visione / Saggezza": "远见 / 智慧",
    "Inadeguatezza / Imbarazzo": "不适 / 尴尬",
    "Bellezza / Attenzione": "美 / 注目",
    "Fortuna / Successo": "运气 / 成功",
    "Intromissione / Chiacchiere": "多管闲事 / 闲话",
    "Affidabilità / Carattere": "可靠 / 个性",
    "Sostegno / Entusiasmo": "支持 / 热情",
    "Affetto / Preferenza": "喜爱 / 偏爱",
    "Rancore / Ostilità": "怨恨 / 敌意",
    "Autorità / Minaccia": "权威 / 威胁",
    "Necessità / Decisione": "必然 / 决断",
    "Esperienza / Socialità": "阅历 / 社交",
    "Giardinaggio / Talento": "园艺 / 天赋",    "Agitazione / Energia": "躁动 / 精力",
    "Legge / Prigione": "法律 / 监狱",
    "Imbarazzo / Vergogna": "尴尬 / 丢脸",
    "Presa in giro / Scherzo": "捉弄 / 玩笑",
    "Fastidio / Noia": "烦扰 / 惹厌",
    "Capacità / Competenza": "能力 / 本事",
    "Impegno / Sforzo": "努力 / 拼命",
    "Aspettativa / Desiderio": "期盼 / 渴望",
    "Finta / Indifferenza": "佯装 / 漠然",
    "Bontà / Gentilezza": "善良 / 好人",
    "Parole / Impegno": "言语 / 承诺",
    "Abbondanza / Sa zietà": "充足 / 尽兴",
    "Fine / Rovina": "末路 / 破产",
    "Impossibilità / Limitazione": "无奈 / 受限",
    "Coraggio / Azione": "勇气 / 行动",
    "Emozione / Eccitazione": "情绪 / 兴奋",
    "Fuga / Ignorare": "逃避 / 装死",
    "Paura / Allarme": "惊恐 / 害怕",
    "Sconfitta / Crisi": "失败 / 崩溃",
    "Saggezza / Maturità": "明智 / 成熟",
    "Bontà / Santità": "圣善 / 完人",
    "Prudenza / Compromesso": "折中 / 稳妥",
    "Sospetto / Dubbio": "怀疑 / 起疑",
    "Confusione / Incertezza": "困惑 / 迷茫",
    "Termine / Fine": "大限 / 末日",
    "Noia / Inutilità": "无趣 / 无用",
    "Umore / Cattivo umore": "心情 / 闹脾气",
    "Vantaggio / Successo": "优势 / 胜券",
    "Opportunità / Futuro": "机遇 / 坦途",
    "Crudeltà / Tortura": "折磨 / 刁难",
    "Esclusione / Sconfitta": "出局 / 淘汰",
    "Conseguenze / Danno": "代价 / 后果",
    "Pigrizia / Inazione": "怠惰 / 袖手",
    "Partenza / Addio": "离别 / 远走",
    "Fallimento / Annullamento": "落空 / 告吹",
    "Chiarezza / Onestà": "坦诚 / 摊牌",
    "Disonestà / Furto": "揩油 / 贪占",
    "Cibo / Abbitudine": "饮食 / 不挑食",
    "Memoria / Dimenticanza": "记忆 / 健忘",
    "Abilità / Pratica": "本事 / 上手",
    "Mistero / Riservatezza": "神秘 / 难懂",
    "Commozione / Emozione": "感动 / 哽咽",
    "Gioia / Entusiasmo": "喜悦 / 欢欣",
    "Sfacciataggine / Audacia": "厚脸皮 / 无耻",
    "Errore / Sbaglio": "失误 / 错判",
    "Colpa / Scoperta": "被抓 / 现行",
    "Amore / Corteggiamento": "爱慕 / 追求",
    "Attesa / Tensione": "紧张 / 悬心",
    "Rassegnazione / Addio": "认命 / 放下",

    "Affari / Intuizione": "事务 / 直觉",
    "Amicizia / Lealtà": "友谊 / 忠诚",
    "Apparenza / Cautela": "表象 / 审慎",
    "Apparenza / Giudizio": "表象 / 判断",
    "Apparenza / Simulazione": "表象 / 伪装",
    "Attenzione / Distrazione": "注意力 / 分心",
    "Auguri / Incoraggiamento": "祝福 / 鼓励",
    "Azione / Rischio": "行动 / 风险",
    "Collaborazione / Comunità": "协作 / 社区",
    "Comunicazione / Chiacchiere": "沟通 / 闲聊",
    "Comunicazione / Sincerità": "沟通 / 坦诚",
    "Conoscenza / Intuizione": "认知 / 直觉",
    "Consolazione / Realismo": "安慰 / 现实",
    "Contraddizione / Ambiguità": "矛盾 / 两面性",
    "Critica / Difetto / Ironia": "批评 / 缺点 / 讽刺",
    "Critica / Influenza / Saggezza": "批评 / 影响 / 智慧",
    "Critica / Maldicenza": "批评 / 诽谤",
    "Critica / Perfezionismo": "批评 / 完美主义",
    "Difetto / Economia": "缺点 / 理财",
    "Distrazione / Sognare": "分心 / 幻想",
    "Dolore / Stanchezza": "痛苦 / 疲惫",
    "Economia / Valore": "理财 / 价值",
    "Efficienza / Strategia": "效率 / 策略",
    "Emozioni / Rabbia": "情绪 / 愤怒",
    "Energia / Attività": "精力 / 活动",
    "Errore / Imbarazzo": "错误 / 尴尬",
    "Facilità / Semplicità": "轻松 / 简单",
    "Famiglia / Gusto personale": "家庭 / 个人品味",
    "Gratitudine / Relazioni": "感恩 / 人际关系",
    "Incoerenza / Doppiezza": "不一贯 / 两面派",
    "Incoraggiamento / Apprendimento": "鼓励 / 学习",
    "Incoraggiamento / Azione": "鼓励 / 行动",
    "Incoraggiamento / Ottimismo": "鼓励 / 乐观",
    "Indipendenza / Azione": "独立 / 行动",
    "Influenza / Potere": "影响 / 权力",
    "Influenza / Relazioni": "影响 / 人际关系",
    "Interesse / Opportunismo": "利益 / 投机",
    "Ironia / Realismo": "讽刺 / 现实",
    "Ironia / Stupidità": "讽刺 / 愚蠢",
    "Lavoro / Fatica": "工作 / 辛苦",
    "Libertà / Autonomia": "自由 / 自主",
    "Logica / Ordine": "逻辑 / 秩序",
    "Ostacolo / Impedimento": "障碍 / 阻碍",
    "Pace / Riconciliazione": "和平 / 和解",
    "Partecipazione / Influenza": "参与 / 影响",
    "Pazienza / Limite": "耐心 / 边界",
    "Pazienza / Perseveranza": "耐心 / 坚毅",
    "Perseveranza / Determinazione": "坚毅 / 决心",
    "Piacere / Vizio": "享乐 / 恶习",
    "Potere / Autorità": "权力 / 权威",
    "Preparazione / Conoscenza": "准备 / 认知",
    "Promesse / Incoerenza": "承诺 / 不一贯",
    "Prudenza / Sicurezza": "谨慎 / 保障",
    "Rarità / Tempo": "稀有 / 时间",
    "Rarità / Unicità": "稀有 / 独特",
    "Realismo / Praticità": "现实 / 实用",
    "Realismo / Saggezza": "现实 / 智慧",
    "Relazioni / Affari": "人际关系 / 事务",
    "Relazioni / Amicizia": "人际关系 / 友谊",
    "Relazioni / Giudizio": "人际关系 / 判断",
    "Ricerca / Difficoltà": "寻找 / 困难",
    "Riconciliazione / Amicizia": "和解 / 友谊",
    "Rimprovero / Ironia": "责备 / 讽刺",
    "Risentimento / Sottomissione": "隐忍 / 屈从",
    "Riserva / Strategia": "底牌 / 策略",
    "Saggezza / Azione": "智慧 / 行动",
    "Saggezza / Felicità": "智慧 / 幸福",
    "Saggezza / Moderazione": "智慧 / 适度",
    "Saggezza / Organizzazione": "智慧 / 规划",
    "Saggezza / Pazienza": "智慧 / 耐心",
    "Saggezza / Prudenza": "智慧 / 谨慎",
    "Saggezza / Strategia": "智慧 / 策略",
    "Segretezza / Riservatezza": "保密 / 谨慎",
    "Similarità / Affinità": "相似 / 投缘",
    "Sorveglianza / Gestione": "监督 / 管理",
    "Strategia / Azione": "策略 / 行动",
    "Successo / Progresso": "成功 / 进步",
    "Tempo / Azione": "时间 / 行动",
    "Tempo / Pazienza": "时间 / 耐心",
    "Vantaggio / Potere": "优势 / 权力",
    "Vendetta / Soddisfazione": "复仇 / 满足",
}
